...
const OfferModal = ({ collection, open, handleClose, theme, id, userWallet, nft, setHasOffered, getNFT }) => {
    console.log(nft)
    ...
    const editAssetActivity = async (event, price) => {
        ...
        assetTemp.push({ event: event, expiration: expiration ? expiration : defaultExp, price: price, from_wallet_address: userWallet, receiver_id: nft.current_owner, date: this_time, copies: 1 })
            ...
            >
                <Box sx={{
                    ...
                    <div className="d-flex flex-column mb-3"><p className="mb-1">Duration</p>
                        <div className="d-flex align-items-center justify-content-between">
                            ...
                            <div className="d-flex flex-column align-items-end ms-1">
                                <Subtitle>{convertDate(new Date())}</Subtitle>
                                <Subtitle>{convertHour(new Date())}</Subtitle>
                            </div>
                        </div>
                    </div>
                    {/* </div> */}
                    {apiLoading ? <ButtonLarge>
                        ...
                        <ButtonLarge onClick={handleSubmit}>make offer</ButtonLarge>}
