        ...
        <>
            <Contnr className="d-flex flex-column">
                ...
                <div className="d-flex align-items-center my-2">
                    <CheckPut id="sold-item" onClick={handleCheck} />
                ...
                <div className="d-flex align-items-center my-2">
                    <CheckPut id="bid-activity" onClick={handleCheck} />
                ...
                <div className="d-flex align-items-center my-2">
                    <CheckPut id="price-change" onClick={handleCheck} />
                    <CheckDes className="d-flex flex-column ms-2">
                ...
                <div className="d-flex align-items-center my-2">
                    <CheckPut id="auction-expiration" onClick={handleCheck} />
                    <CheckDes className="d-flex flex-column ms-2">
                ...
                <div className="d-flex align-items-center my-2">
                    <CheckPut id="outbid" onClick={handleCheck} />
                    <CheckDes className="d-flex flex-column ms-2">
                ...
                <div className="d-flex align-items-center my-2">
                    <CheckPut id="owned-item-updates" onClick={handleCheck} />
                    <CheckDes className="d-flex flex-column ms-2">
                ...
                <div className="d-flex align-items-center my-2">
                    <CheckPut id="successfull-purchase" onClick={handleCheck} />
                    <CheckDes className="d-flex flex-column ms-2">
